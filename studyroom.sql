...
CREATE TABLE `forum_post`  (
  ...
  `post_type` int(11) NULL DEFAULT 1,
  ...
  `is_essence` int(11) NULL DEFAULT 0,
...
INSERT INTO `forum_post` VALUES (11, 4, 2, '图书馆使用小贴士', '来图书馆学习几年了，总结了一些小贴士：早上8点前来可以占到好位置，带个水杯可以接热水，记得带耳机避免打扰他人。', 1, 2345, 67, 189, 1, 1, 0, NULL, NULL, NULL, '2026-03-08 09:05:41', '2026-03-20 09:05:41', 0);
...
INSERT INTO `forum_post` VALUES (29, 12, 3, '占座现象严重', '早上来图书馆发现很多座位被书本占了但没人坐，这种现象太严重了。希望管理员能管管。', 1, 2353, 90, 156, 1, 1, 0, NULL, NULL, NULL, '2026-03-19 09:05:41', '2026-03-20 09:05:41', 0);
...
INSERT INTO `forum_post` VALUES (41, 3, 1, '上报：图书馆A区102号座位电源损坏', '图书馆A区102号座位的电源插座已损坏，无法使用。请管理员尽快维修，谢谢。', 1, 15, 2, 3, 1, 0, 0, NULL, NULL, NULL, '2026-03-20 09:30:22', '2026-03-20 09:30:22', 0);
...
INSERT INTO `forum_post` VALUES (49, 3, 1, '上报：图书馆A区102号座位电源损坏', '图书馆A区102号座位的电源插座已损坏，无法使用。请管理员尽快维修，谢谢。', 1, 15, 2, 3, 1, 0, 0, NULL, NULL, NULL, '2026-03-20 09:32:05', '2026-03-22 17:32:19', 0);
INSERT INTO `forum_post` VALUES (50, 4, 2, '投诉：有人长时间占座不在', '教学楼B区305室每天上午都有人用书包占座，但本人不在场，希望管理员加强巡查。', 1, 28, 5, 12, 1, 0, 0, NULL, NULL, NULL, '2026-03-20 09:32:05', '2026-03-20 09:32:05', 0);
INSERT INTO `forum_post` VALUES (51, 5, 3, '申诉：误判违约处理', '3月15日因临时有事无法准时签到，系统自动判定违约，希望管理员核实情况并取消违约记录。', 1, 22, 3, 8, 2, 0, 0, NULL, NULL, NULL, '2026-03-20 09:32:05', '2026-03-20 09:32:05', 0);
INSERT INTO `forum_post` VALUES (52, 6, 4, '建议增加夜间自习室开放时间', '希望学校能在考试周期间延长自习室开放时间至24:00，方便复习的同学。', 1, 56, 8, 23, 0, 0, 0, NULL, NULL, NULL, '2026-03-20 09:32:05', '2026-03-20 09:32:05', 0);
INSERT INTO `forum_post` VALUES (53, 7, 1, '上报：B区205自习室投影仪故障', 'B区205自习室的投影仪出现花屏问题，影响学习使用，请尽快维修。', 1, 19, 1, 4, 1, 0, 0, NULL, NULL, NULL, '2026-03-20 09:32:05', '2026-03-20 09:32:05', 0);
INSERT INTO `forum_post` VALUES (54, 8, 2, '反馈：自习室噪音问题', '图书馆B区经常有同学大声讲话，影响他人学习，建议加强管理力度。', 1, 33, 6, 15, 0, 0, 0, NULL, NULL, NULL, '2026-03-20 09:32:05', '2026-03-20 09:32:05', 0);
INSERT INTO `forum_post` VALUES (55, 9, 3, '申诉：系统操作错误导致违约', '使用手机预约时误操作取消了已签到的记录，导致系统显示违约，请核实处理。', 1, 18, 2, 6, 1, 0, 0, NULL, NULL, NULL, '2026-03-20 09:32:05', '2026-03-20 10:53:15', 0);
INSERT INTO `forum_post` VALUES (56, 10, 4, '建议：增加残疾人座位标识', '建议在自习室座位布局图中增加残疾人专用座位标识，方便有特殊需求的同学预约。', 1, 41, 4, 18, 0, 0, 0, NULL, NULL, NULL, '2026-03-20 09:32:05', '2026-03-20 09:32:05', 0);
...
INSERT INTO `forum_post` VALUES (59, 5, 3, '有人占座一整天不见人', '早上8点来就看到座位上有书，现在下午5点了还没人来，太离谱了！', 3, 234, 15, 67, 1, 1, 0, NULL, NULL, NULL, '2026-03-13 17:00:00', '2026-03-13 17:00:00', 0);
...
CREATE TABLE `forum_reply`  (
  ...
  `is_accepted` tinyint(4) NULL DEFAULT 0 COMMENT '是否被采纳',
...
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '论坛回复表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `notice`  (
  ...
  `publisher_type` int(11) NULL DEFAULT 1 COMMENT '??????1-??????2-??????',
  `is_top` tinyint(4) NULL DEFAULT 0 COMMENT '是否置顶：0-否 1-是',
  `view_count` int(11) NULL DEFAULT 0 COMMENT '浏览次数',
  `status` int(11) NULL DEFAULT 1 COMMENT '状态：0-草稿 1-已发布 2-已下架',
  `publish_time` datetime NULL DEFAULT NULL COMMENT '发布时间',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` int(11) NULL DEFAULT 0,
  `audit_status` int(11) NULL DEFAULT 0 COMMENT '?????0-????1-?????2-?????',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_notice_publisher_id`(`publisher_id` ASC) USING BTREE,
  CONSTRAINT `fk_notice_publisher_id` FOREIGN KEY (`publisher_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '公告表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `reservation`  (
  ...
  `status` int(11) NULL DEFAULT 0 COMMENT '状态：0-待签到 1-使用中 2-已完成 3-已违约 4-已取消',
  ...
  `violation_count` int(11) NULL DEFAULT 0 COMMENT '违约次数',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_res_user_id`(`user_id` ASC) USING BTREE,
  INDEX `fk_res_room_id`(`room_id` ASC) USING BTREE,
  INDEX `fk_res_seat_id`(`seat_id` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '预约表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of reservation
-- ----------------------------
INSERT INTO `reservation` VALUES (1, 3, 1, 1, '2026-03-20', '08:00:00', '12:00:00', 0, NULL, NULL, NULL, NULL, 0, '2026-03-19 16:44:31', '2026-03-19 16:44:31');
INSERT INTO `reservation` VALUES (2, 4, 1, 2, '2026-03-20', '14:00:00', '18:00:00', 0, NULL, NULL, NULL, NULL, 0, '2026-03-19 16:44:31', '2026-03-19 16:44:31');
INSERT INTO `reservation` VALUES (3, 5, 2, 61, '2026-03-21', '09:00:00', '12:00:00', 0, NULL, NULL, NULL, NULL, 0, '2026-03-19 16:44:31', '2026-03-19 16:44:31');
INSERT INTO `reservation` VALUES (4, 6, 3, 101, '2026-03-19', '08:00:00', '12:00:00', 1, NULL, NULL, NULL, NULL, 0, '2026-03-19 16:44:31', '2026-03-19 16:44:31');
INSERT INTO `reservation` VALUES (5, 7, 1, 3, '2026-03-19', '13:00:00', '17:00:00', 1, NULL, NULL, NULL, NULL, 0, '2026-03-19 16:44:31', '2026-03-19 16:44:31');
INSERT INTO `reservation` VALUES (6, 8, 5, 221, '2026-03-18', '08:00:00', '12:00:00', 2, NULL, NULL, NULL, NULL, 0, '2026-03-19 16:44:31', '2026-03-19 16:44:31');
INSERT INTO `reservation` VALUES (7, 9, 6, 271, '2026-03-18', '14:00:00', '18:00:00', 2, NULL, NULL, NULL, NULL, 0, '2026-03-19 16:44:31', '2026-03-19 16:44:31');
INSERT INTO `reservation` VALUES (8, 10, 1, 4, '2026-03-17', '08:00:00', '12:00:00', 4, NULL, NULL, NULL, NULL, 0, '2026-03-19 16:44:31', '2026-03-19 16:44:31');
INSERT INTO `reservation` VALUES (9, 11, 2, 62, '2026-03-17', '09:00:00', '12:00:00', 4, NULL, NULL, NULL, NULL, 0, '2026-03-19 16:44:31', '2026-03-19 16:44:31');
INSERT INTO `reservation` VALUES (10, 12, 3, 102, '2026-03-22', '10:00:00', '14:00:00', 0, NULL, NULL, NULL, NULL, 0, '2026-03-19 16:44:31', '2026-03-19 16:44:31');
INSERT INTO `reservation` VALUES (11, 3, 1, 8, '2026-03-19', '08:30:00', '09:30:00', 0, NULL, NULL, NULL, NULL, 0, '2026-03-19 18:32:15', '2026-03-19 18:32:15');
INSERT INTO `reservation` VALUES (12, 3, 2, 66, '2026-03-19', '18:30:00', '19:00:00', 3, NULL, NULL, '2026-03-20 10:51:16', NULL, 0, '2026-03-19 18:32:55', '2026-03-20 10:51:16');
INSERT INTO `reservation` VALUES (13, 5, 1, 10, '2026-03-10', '08:00:00', '10:00:00', 2, NULL, NULL, NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (14, 5, 1, 11, '2026-03-11', '14:00:00', '16:00:00', 2, '2026-03-11 14:05:00', '2026-03-11 15:58:00', NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (15, 5, 2, 50, '2026-03-12', '09:00:00', '11:00:00', 2, '2026-03-12 09:10:00', '2026-03-12 11:00:00', NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (16, 5, 3, 100, '2026-03-13', '19:00:00', '21:00:00', 2, '2026-03-13 19:05:00', '2026-03-13 21:00:00', NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (17, 5, 1, 12, '2026-03-14', '08:00:00', '10:00:00', 2, '2026-03-14 08:02:00', '2026-03-14 10:00:00', NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (18, 5, 2, 51, '2026-03-15', '10:00:00', '12:00:00', 2, '2026-03-15 10:08:00', '2026-03-15 12:00:00', NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (19, 5, 1, 13, '2026-03-17', '14:00:00', '17:00:00', 2, '2026-03-17 14:03:00', '2026-03-17 17:00:00', NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (20, 5, 3, 101, '2026-03-18', '19:00:00', '21:00:00', 2, '2026-03-18 19:01:00', '2026-03-18 21:00:00', NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (21, 6, 1, 14, '2026-03-19', '08:00:00', '10:00:00', 0, NULL, NULL, NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (22, 6, 2, 52, '2026-03-19', '14:00:00', '16:00:00', 1, '2026-03-20 09:32:04', NULL, NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (23, 7, 1, 15, '2026-03-20', '09:00:00', '11:00:00', 0, NULL, NULL, NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (24, 7, 3, 102, '2026-03-20', '19:00:00', '21:00:00', 0, NULL, NULL, NULL, NULL, 0, '2026-03-20 09:32:04', '2026-03-20 09:32:04');
INSERT INTO `reservation` VALUES (25, 8, 1, 16, '2026-03-16', '08:00:00', '10:00:00', 2, '2026-03-16 08:05:00', '2026-03-16 10:00:00', NULL, NULL, 0, '2026-03-20 09:32:05', '2026-03-20 09:32:05');
INSERT INTO `reservation` VALUES (26, 9, 2, 53, '2026-03-15', '16:00:00', '18:00:00', 2, '2026-03-15 16:04:00', '2026-03-15 18:00:00', NULL, NULL, 0, '2026-03-20 09:32:05', '2026-03-20 09:32:05');
INSERT INTO `reservation` VALUES (27, 10, 3, 103, '2026-03-14', '10:00:00', '12:00:00', 2, '2026-03-14 10:06:00', '2026-03-14 12:00:00', NULL, NULL, 0, '2026-03-20 09:32:05', '2026-03-20 09:32:05');
INSERT INTO `reservation` VALUES (28, 11, 1, 17, '2026-03-13', '08:00:00', '10:00:00', 2, '2026-03-13 08:03:00', '2026-03-13 10:00:00', NULL, NULL, 0, '2026-03-20 09:32:05', '2026-03-20 09:32:05');
INSERT INTO `reservation` VALUES (29, 12, 2, 54, '2026-03-12', '14:00:00', '16:00:00', 2, '2026-03-12 14:05:00', '2026-03-12 16:00:00', NULL, NULL, 0, '2026-03-20 09:32:05', '2026-03-20 09:32:05');
INSERT INTO `reservation` VALUES (30, 13, 3, 104, '2026-03-11', '19:00:00', '21:00:00', 2, '2026-03-11 19:02:00', '2026-03-11 21:00:00', NULL, NULL, 0, '2026-03-20 09:32:05', '2026-03-20 09:32:05');
INSERT INTO `reservation` VALUES (31, 14, 1, 18, '2026-03-10', '14:00:00', '16:00:00', 2, '2026-03-10 14:04:00', '2026-03-10 16:00:00', NULL, NULL, 0, '2026-03-20 09:32:05', '2026-03-20 09:32:05');
INSERT INTO `reservation` VALUES (32, 15, 2, 55, '2026-03-11', '09:00:00', '11:00:00', 2, '2026-03-11 09:07:00', '2026-03-11 11:00:00', NULL, NULL, 0, '2026-03-20 09:32:05', '2026-03-20 09:32:05');
INSERT INTO `reservation` VALUES (33, 3, 1, 6, '2026-03-20', '10:00:00', '10:30:00', 0, NULL, NULL, NULL, NULL, 0, '2026-03-20 10:36:11', '2026-03-20 10:36:11');
INSERT INTO `reservation` VALUES (34, 3, 2, 64, '2026-03-20', '11:00:00', '11:30:00', 2, '2026-03-20 10:51:05', '2026-03-20 10:51:06', NULL, NULL, 0, '2026-03-20 10:36:38', '2026-03-20 10:51:06');
INSERT INTO `reservation` VALUES (35, 3, 1, 9, '2026-03-20', '11:00:00', '11:30:00', 2, '2026-03-20 10:51:33', '2026-03-20 10:51:34', NULL, NULL, 0, '2026-03-20 10:51:29', '2026-03-20 10:51:34');
INSERT INTO `reservation` VALUES (36, 3, 1, 5, '2026-04-12', '08:00:00', '10:30:00', 3, NULL, NULL, '2026-04-12 11:35:10', '预约超时未签到，系统自动取消', 0, '2026-04-12 11:35:08', '2026-04-12 11:35:10');
INSERT INTO `reservation` VALUES (37, 3, 1, 45, '2026-04-12', '11:30:00', '14:30:00', 0, NULL, NULL, NULL, NULL, 0, '2026-04-12 11:35:37', '2026-04-12 11:35:37');
...
CREATE TABLE `seat`  (
  ...
  `status` int(11) NULL DEFAULT 1 COMMENT '状态：0-不可用 1-可用 2-占用中 3-维修中',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `position_x` int(11) NULL DEFAULT NULL COMMENT '座位自定义X坐标',
  `position_y` int(11) NULL DEFAULT NULL COMMENT '座位自定义Y坐标',
  `seat_type` int(11) NULL DEFAULT 1 COMMENT '?????1-?????2-???3-??/??',
  `tags` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '?????JSON???????[\"??\",\"???\"]',
  `width` int(11) NULL DEFAULT NULL COMMENT '自定义宽度（px），用于过道/柱子',
  `height` int(11) NULL DEFAULT NULL COMMENT '自定义高度（px），用于过道/柱子',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_seat_room_id`(`room_id` ASC) USING BTREE,
  CONSTRAINT `fk_seat_room_id` FOREIGN KEY (`room_id`) REFERENCES `study_room` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 399 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '座位表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of seat
-- ----------------------------
INSERT INTO `seat` VALUES (1, 1, 'A01', 1, 1, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 1020, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (2, 1, 'A02', 1, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 120, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (3, 1, 'A03', 1, 3, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 20, 120, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (4, 1, 'A04', 1, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 320, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (5, 1, 'A05', 1, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 420, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (6, 1, 'A06', 1, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 520, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (7, 1, 'A07', 1, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 620, 20, 1, '[\"靠窗\"]', NULL, NULL);
INSERT INTO `seat` VALUES (8, 1, 'A08', 1, 8, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 720, 20, 1, '[\"靠门近\",\"宽敞\",\"角落位置\"]', NULL, NULL);
INSERT INTO `seat` VALUES (9, 1, 'A09', 1, 9, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 820, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (10, 1, 'A10', 1, 10, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 920, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (11, 1, 'B01', 2, 1, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 1020, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (12, 1, 'B02', 2, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 120, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (13, 1, 'B03', 2, 3, 3, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 20, 200, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (14, 1, 'B04', 2, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 320, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (15, 1, 'B05', 2, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 420, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (16, 1, 'B06', 2, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 520, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (17, 1, 'B07', 2, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 620, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (18, 1, 'B08', 2, 8, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 720, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (19, 1, 'B09', 2, 9, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 820, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (20, 1, 'B10', 2, 10, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 920, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (21, 1, 'C01', 3, 1, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 1020, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (22, 1, 'C02', 3, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 120, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (23, 1, 'C03', 3, 3, 3, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 20, 280, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (24, 1, 'C04', 3, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 320, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (25, 1, 'C05', 3, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 420, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (26, 1, 'C06', 3, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 520, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (27, 1, 'C07', 3, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 620, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (28, 1, 'C08', 3, 8, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 720, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (29, 1, 'C09', 3, 9, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 820, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (30, 1, 'C10', 3, 10, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 920, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (31, 1, 'D01', 4, 1, 3, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 1120, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (32, 1, 'D02', 4, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 120, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (33, 1, 'D03', 4, 3, 3, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 20, 360, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (34, 1, 'D04', 4, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 320, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (35, 1, 'D05', 4, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 420, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (36, 1, 'D06', 4, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 520, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (37, 1, 'D07', 4, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 620, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (38, 1, 'D08', 4, 8, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 720, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (39, 1, 'D09', 4, 9, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 820, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (40, 1, 'D10', 4, 10, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 920, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (41, 1, 'E01', 5, 1, 3, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 1020, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (42, 1, 'E02', 5, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 120, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (43, 1, 'E03', 5, 3, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 220, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (44, 1, 'E04', 5, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 320, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (45, 1, 'E05', 5, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 420, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (46, 1, 'E06', 5, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 520, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (47, 1, 'E07', 5, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 620, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (48, 1, 'E08', 5, 8, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 720, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (49, 1, 'E09', 5, 9, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 820, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (50, 1, 'E10', 5, 10, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 920, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (51, 1, 'F01', 6, 1, 3, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 1020, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (52, 1, 'F02', 6, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 120, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (53, 1, 'F03', 6, 3, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 220, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (54, 1, 'F04', 6, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 320, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (55, 1, 'F05', 6, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 420, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (56, 1, 'F06', 6, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 520, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (57, 1, 'F07', 6, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 620, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (58, 1, 'F08', 6, 8, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 720, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (59, 1, 'F09', 6, 9, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 820, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (60, 1, 'F10', 6, 10, 1, '2026-03-19 16:44:31', '2026-04-12 11:20:38', 920, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (61, 2, 'A01', 1, 1, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 20, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (62, 2, 'A02', 1, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 120, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (63, 2, 'A03', 1, 3, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 220, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (64, 2, 'A04', 1, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 320, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (65, 2, 'A05', 1, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 420, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (66, 2, 'A06', 1, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 520, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (67, 2, 'A07', 1, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 620, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (68, 2, 'A08', 1, 8, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 920, 20, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (69, 2, 'B01', 2, 1, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 20, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (70, 2, 'B02', 2, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 120, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (71, 2, 'B03', 2, 3, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 220, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (72, 2, 'B04', 2, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 320, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (73, 2, 'B05', 2, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 420, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (74, 2, 'B06', 2, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 520, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (75, 2, 'B07', 2, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 620, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (76, 2, 'B08', 2, 8, 3, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 920, 100, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (77, 2, 'C01', 3, 1, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 20, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (78, 2, 'C02', 3, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 120, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (79, 2, 'C03', 3, 3, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 220, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (80, 2, 'C04', 3, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 320, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (81, 2, 'C05', 3, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 420, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (82, 2, 'C06', 3, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 520, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (83, 2, 'C07', 3, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 620, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (84, 2, 'C08', 3, 8, 3, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 920, 180, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (85, 2, 'D01', 4, 1, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 20, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (86, 2, 'D02', 4, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 120, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (87, 2, 'D03', 4, 3, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 220, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (88, 2, 'D04', 4, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 320, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (89, 2, 'D05', 4, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 420, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (90, 2, 'D06', 4, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 520, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (91, 2, 'D07', 4, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 620, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (92, 2, 'D08', 4, 8, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 920, 260, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (93, 2, 'E01', 5, 1, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 20, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (94, 2, 'E02', 5, 2, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 120, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (95, 2, 'E03', 5, 3, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 220, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (96, 2, 'E04', 5, 4, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 320, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (97, 2, 'E05', 5, 5, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 420, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (98, 2, 'E06', 5, 6, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 520, 340, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (99, 2, 'E07', 5, 7, 1, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 620, 340, 1, '[\"靠门近\",\"宽敞\",\"有插座\"]', NULL, NULL);
INSERT INTO `seat` VALUES (100, 2, 'E08', 5, 8, 3, '2026-03-19 16:44:31', '2026-04-12 11:21:17', 220, 420, 1, NULL, NULL, NULL);
INSERT INTO `seat` VALUES (101, 3, 'A01', 1, 1, 1, '2026-03-19 16:44:31', '2026-03-19 16:44:31', NULL, NULL, 1, NULL, NULL, NULL);
...
INSERT INTO `seat` VALUES (110, 3, 'A10', 1, 10, 1, '2026-03-19 16:44:31', '2026-03-19 16:44:31', NULL, NULL, 1, NULL, NULL, NULL);
...
INSERT INTO `seat` VALUES (396, 1, '', 0, 0, 0, '2026-04-12 11:09:37', '2026-04-12 11:20:38', 1020, 20, 2, NULL, 80, 60);
INSERT INTO `seat` VALUES (397, 1, '', 0, 0, 0, '2026-04-12 11:09:55', '2026-04-12 11:20:38', 220, 20, 2, NULL, 80, 300);
INSERT INTO `seat` VALUES (398, 2, '', 0, 0, 0, '2026-04-12 11:20:57', '2026-04-12 11:21:17', 820, 20, 2, NULL, 80, 300);
...
CREATE TABLE `seat_tag`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `room_id` bigint(20) NOT NULL COMMENT '???ID',
...
CREATE TABLE `study_room`  (
  ...
  `row_count` int(11) NULL DEFAULT 5 COMMENT '座位行数',
  `col_count` int(11) NULL DEFAULT 10 COMMENT '座位列数',
  `open_time` time NULL DEFAULT '08:00:00' COMMENT '开放时间',
  `close_time` time NULL DEFAULT '22:00:00' COMMENT '关闭时间',
  `has_air_condition` tinyint(4) NULL DEFAULT 1 COMMENT '是否有空调',
  `has_wifi` tinyint(4) NULL DEFAULT 1 COMMENT '是否有WiFi',
  `has_power` tinyint(4) NULL DEFAULT 1 COMMENT '是否有电源',
  ...
  `status` int(11) NULL DEFAULT 1 COMMENT '状态：0-关闭 1-开放 2-维护中',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_sr_admin_id`(`admin_id` ASC) USING BTREE,
  CONSTRAINT `fk_sr_admin_id` FOREIGN KEY (`admin_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '自习室表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of study_room
-- ----------------------------
INSERT INTO `study_room` VALUES (1, '图书馆一楼自习室A', '图书馆', 1, '101', '普通', 60, 6, 10, '08:00:00', '22:00:00', 1, 1, 1, '宽敞明亮的自习室，配备空调和WiFi', '/images/1.png', 2, 1, '2026-03-19 16:44:31', '2026-03-20 09:09:30', 0);
...
CREATE TABLE `sys_user`  (
  ...
  `user_type` int(11) NULL DEFAULT 1 COMMENT '用户类型：1-普通用户 2-自习室管理员 3-系统管理员',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'admin', '系统管理员', '13800138000', 'admin@studyroom.com', NULL, 3, 1, '2026-04-13 17:29:58', '2026-03-19 16:44:31', '2026-03-19 17:29:02', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (2, 'zxsadmin', 'admin', '自习室管理员', '13800138001', 'zxsadmin@studyroom.com', NULL, 2, 1, '2026-04-13 17:29:29', '2026-03-19 16:44:31', '2026-03-20 10:53:25', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (3, 'user', 'admin', '测试用户', '13800138002', 'user@studyroom.com', NULL, 1, 1, '2026-04-12 11:45:52', '2026-03-19 16:44:31', '2026-03-19 17:29:11', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (4, 'zhangsan', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '张三', '13900139001', 'zhangsan@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (5, 'lisi', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '李四', '13900139002', 'lisi@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (6, 'wangwu', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '王五', '13900139003', 'wangwu@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (7, 'zhaoliu', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '赵六', '13900139004', 'zhaoliu@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (8, 'sunqi', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '孙七', '13900139005', 'sunqi@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (9, 'zhouba', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '周八', '13900139006', 'zhouba@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (10, 'wujiu', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '吴九', '13900139007', 'wujiu@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (11, 'zhengshi', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '郑十', '13900139008', 'zhengshi@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (12, 'chenyi', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '陈一', '13900139009', 'chenyi@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (13, 'linerm', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '林二', '13900139010', 'linerm@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (14, 'huangsan', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '黄三', '13900139011', 'huangsan@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (15, 'heisi', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '何四', '13900139012', 'heisi@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (16, 'gaowu', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '高五', '13900139013', 'gaowu@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (17, 'liuliu', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '刘六', '13900139014', 'liuliu@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (18, 'linqi', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '林七', '13900139015', 'linqi@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (19, 'guoba', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '郭八', '13900139016', 'guoba@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (20, 'luojiu', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EO', '罗九', '13900139017', 'luojiu@example.com', NULL, 1, 1, NULL, '2026-03-19 16:44:31', '2026-03-19 16:44:31', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (21, '123', '$2a$10$mXFO/NJoh0Lv3b8tgBFDG.SzckUMV1ISGuBFkenXJ4wXxrZEcH5Va', '1232', '15899999655', '', NULL, 1, 1, '2026-03-19 17:23:52', '2026-03-19 16:57:23', '2026-03-20 10:59:07', 1, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (22, '123456', '$2a$10$qt5cTcQ3wctht81iTvqBvetw1QN16WM2IThGzzWuBSCGdJR38yM3.', '123456', '123456', '123456@123456', NULL, 1, 1, '2026-04-12 11:36:02', '2026-04-12 11:35:58', '2026-04-12 11:35:58', 0, NULL, NULL, NULL, NULL);
...
CREATE TABLE `sys_user_role`  (
  ...
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_sur_user_id`(`user_id` ASC) USING BTREE,
  INDEX `fk_sur_role_id`(`role_id` ASC) USING BTREE,
